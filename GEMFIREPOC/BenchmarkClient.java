...
public class BenchmarkClient {
  ...
  public static final int NUMBER_OF_SAMPLES = Integer.getInteger("benchmark.number-of-samples", 1);

  /** Number of put operations to execute for each sampling */
  public static final int OPERATIONS_PER_SAMPLE = Integer.getInteger("benchmark.operations-per-sample", 100000);
  ...
  public void go() throws CacheException, IOException {
    ...
    ClientCache cache = new ClientCacheFactory()
        ...
        .set("cache-xml-file", "BenchmarkClient.xml")
        .create();
    ...
    System.out.println("\tvalue is inserted is = " + value);
    ...
    for (; currentSample < numSamples; currentSample++) {    	  
      for (int i = 0; i < operationsPerSample; i++) {
        ...
        exampleRegion.put(String.valueOf(i), value);       
      } 
    ...
    startTimeActual=System.currentTimeMillis();
    System.out.println("\tValue at 500 key is" + exampleRegion.get("500"));
    System.out.println("\tValue at 1 key is" + exampleRegion.get("1"));
    endTimeActual=System.currentTimeMillis();
    System.out.println("\tTotal Time To Search 2 keys = " + (endTimeActual-startTimeActual));
